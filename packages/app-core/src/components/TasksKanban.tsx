 ...
 *   - 'folder'  — Inbox / Quick / Archive            (live folders only)
 *
 * Cards click to open the source note. DnD is intentionally out of
 * scope for v1 — reordering would require structured edits to the
 * markdown ("- [x]", "!high", "@waiting") and deserves its own pass.
 *
 * Vim navigation:
          ...
          return (
            <div
              ...
              className={[
                ...
                isColumnFocused ? 'border-current/30' : 'border-current/10'
              ].join(' ')}
            >
              <div className="flex shrink-0 items-center justify-between gap-2 border-b border-current/10 px-3 py-2">
