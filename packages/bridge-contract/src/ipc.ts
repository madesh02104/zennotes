...
export const IPC = {
  ...
  APP_GET_TASK_NOTIFICATIONS: 'app:get-task-notifications',
  APP_SET_TASK_NOTIFICATIONS: 'app:set-task-notifications',
  APP_TEST_TASK_NOTIFICATION: 'app:test-task-notification',
  TASKS_OPEN_VIEW: 'tasks:open-view',
